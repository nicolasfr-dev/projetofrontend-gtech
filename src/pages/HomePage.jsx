...
const HomePage = () => {
  return (
    <>
      ...
      <main className="px-4 sm:px-8 md:px-12 lg:px-20 pt-7 bg-light-gray-3 pb-5">
        <Section
      ...
      <section className="w-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 gap-10 lg:gap-20 py-10 bg-white">
        <figure className="w-full lg:w-1/2 flex justify-center items-center relative">
          <div className="w-60 h-60 bg-secondary bg-gradient-to-t from-white to-170% rounded-full relative flex justify-center items-center">
            <img
              className="absolute inset-0 m-auto scale-125"
              src="/air-jordan.png"
              alt="Air Jordan"
            />
          </div>
