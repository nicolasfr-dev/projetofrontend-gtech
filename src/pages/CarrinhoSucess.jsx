...
const CarrinhoSucess = () => {
  ...
  return (
    <>
      <main className=" flex-col justify-center bg-light-gray-3 py-6 w-full h-full">
        <div className="max-w-1/3 mx-auto py-10 px-6 bg-white rounded-md">
          <div className="w-full text-center border-b-1 border-light-gray-2 px-30 pb-5">
          ...
          <div className="space-y-6">
            <section className="border-b-1 border-light-gray-2 py-5">
            ...
            <section className="border-b-1 border-light-gray-2 pb-5">
              <h2 className="text-sm font-bold text-dark-gray-2 mb-2">
            ...
            <section className="border-b-1 border-light-gray-2 pb-5">
              ...
              <p>
                Titular do Cartão: <strong>{nomeCartao?.toUpperCase()}</strong>
              </p>
              <p>
            ...
            <div className="text-center mt-8">
              <button
                ...
                className="text-sm underline text-gray-600 hover:text-dark-gray"
              >
                Imprimir Recibo
              </button>
            </div>
        ...
        <div className="text-center mt-6">
          <button
            onClick={() => navigate("/")}
            className="bg-warning text-white py-3 rounded-md font-semibold w-1/4"
          >
            Voltar para Home
          </button>
        </div>
